...
namespace Entidades
{
    public class Administracion
    {
        ...
        public static void ModificarDatos(Componente componenteEditar, int numeroTransferencia)
        {
            foreach (var componente in Administracion.componentes)
            {
                if(numeroTransferencia == componente.numeroDeTransferencia)
                {
                    componente.id = componenteEditar.id;
        ...
        public static void EliminarComponente(int componenteEliminar)
        {
            foreach (var componente in Administracion.componentes)
            {
                if (componenteEliminar == componente.numeroDeTransferencia) 
                {

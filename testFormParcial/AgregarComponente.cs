    ...
    public partial class AgregarComponente : Form
    {
        ...
        protected virtual void button1_Click(object sender, EventArgs e)
        {
            ...
            if (comboBox1.SelectedIndex == 0)
            {
                ...
                this.discoduro = new DiscoDuro(marcaDisco, tamanio, capacidad, color, fechaCreacionDisco, id, nombre, fechaEntrega, tipoEntrega, metodoPago, precio, numeroTransferencia);
            ...
            if (comboBox1.SelectedIndex == 1)
            {
                ...
                this.memoriaRAM = new MemoriaRAM(velocidad, colorMemoria, marcaMemoria, fechaCreacionMemoria, capacidadMemoria, id, nombre, fechaEntrega, tipoEntrega, metodoPago, precio, numeroTransferencia);
            ...
            if (comboBox1.SelectedIndex == 2)
            {
                ...
                this.tarjetaGrafica = new TarjetaGrafica(marcaTarjeta, serieNvidia, modelo, tamanioTarjeta, fechaCreacionTarjeta, id, nombre, fechaEntrega, tipoEntrega, metodoPago, precio, numeroTransferencia);

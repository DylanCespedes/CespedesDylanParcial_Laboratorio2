...
<<<<<<< HEAD
            ...
            if (comboBox1.SelectedIndex == 0)
            {
                ...
                discoDuro = new DiscoDuro(marcaDisco, tamanio, capacidad, color, fechaCreacionDisco, id, nombre, fechaEntrega, tipoEntrega, metodoPago, precio, numeroTransferencia);
            ...
            if (comboBox1.SelectedIndex == 1) 
            {
                ...
                memoriaRAM = new MemoriaRAM(velocidad, colorMemoria, marcaMemoria, fechaCreacionMemoria, capacidadMemoria, id, nombre, fechaEntrega, tipoEntrega, metodoPago, precio, numeroTransferencia);
            ...
            if (comboBox1.SelectedIndex == 2) 
            {
                ...
                tarjeta = new TarjetaGrafica(marcaTarjeta, serieNvidia, modelo, tamanioTarjeta, fechaCreacionTarjeta, id, nombre, fechaEntrega, tipoEntrega, metodoPago, precio, numeroTransferencia);
                Administracion.componentes.Add(tarjeta);
            }
...
<<<<<<< HEAD
            ...
            else if (comboBox1.SelectedIndex == 1)
            {
                ...
                if(!txtTamanio.Enabled)
                    Enabled = true; 
                else
                    Enabled = false;
                if (!txtCapacidad.Enabled)
                    Enabled = true;
                else
                    Enabled = false;

                if(txtFechaCreacion.Enabled)
                    Enabled = true; 
                else
                    Enabled= false;

    ...
    public partial class AlmacenDeComponentes : Form
    {
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            if (this.dataGridView1.SelectedRows.Count > 0) 
            {
                ...
                DataGridViewRow filaSeleccionada = this.dataGridView1.Rows[0];
                ...
                //Tengo que recuperar ya sea un disco duro, memoria ram o tarjeta grafica



                //Crear un modificar componente y le vamos a mandar los datos del componente a modificar y luego esos datos hay que cargarlos dentro de los textbox
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            if (this.dataGridView1.SelectedRows.Count > 0)
            {
                ...
                {
                    Administracion.EliminarComponente(componenteBorrar.id);
                    dataGridView1.DataSource = null;
                    dataGridView1.DataSource = Administracion.componentes;
                }
                else

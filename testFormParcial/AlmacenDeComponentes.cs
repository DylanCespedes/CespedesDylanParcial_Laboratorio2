...
namespace testFormParcial
{
    ...
    public partial class AlmacenDeComponentes : Form
    {
        ...
        private void discoDuroToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            var TooldiscoDuro = new AgregarComponente();
            TooldiscoDuro.Enabled = true;

            DialogResult dialogResult = TooldiscoDuro.ShowDialog();


            if (dialogResult == DialogResult.OK)
            {

                Componente componente = TooldiscoDuro.Discoduro;
                ...
                MessageBox.Show("El componente se ha creado correctamente!!!", "Aviso!!!", MessageBoxButtons.OK, MessageBoxIcon.Information);

            }
        }

        private void memoriaRAMToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            var ToolmemoriaRam = new AgregarComponente();
            ToolmemoriaRam.Enabled = true;

            DialogResult dialogResult = ToolmemoriaRam.ShowDialog();


            if (dialogResult == DialogResult.OK)
            {

                Componente componente = ToolmemoriaRam.MemoriaRam;
        ...
        private void tarjetaGraficaToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            var ToolTarjetaGrafica = new AgregarComponente();
            ToolTarjetaGrafica.Enabled = true;

            DialogResult dialogResult = ToolTarjetaGrafica.ShowDialog();


            if (dialogResult == DialogResult.OK)
            {

                Componente componente = ToolTarjetaGrafica.Tarjetagrafica;
